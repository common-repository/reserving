...
class Number extends Base_Field {
	...
	public function render_field($label = false) {
		...
		if($label):
			echo wp_kses_post(sprintf('<div class="ray-form-field option-number-wrapper"><label class="ray-option-label"> %s </label>',esc_html( $this->field['title'] )));
		endif; 
	?>
