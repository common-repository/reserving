<?php
    ...
    $home_delivery_info_heading = reserving_setting_option('home_delivery_info_heading', 1);

?>
<div class="form-popup reserving-form-popup reserving-delivery-info-wrapper" id="checkoutDeliveryInfo">
    <?php if($home_delivery_info_heading): ?>
        <h3 class="reserving-delivery-heading"><?php echo esc_html($home_delivery_info_label); ?></h3>
    <?php endif; ?>
