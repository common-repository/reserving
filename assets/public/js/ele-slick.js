(function($) {
    ...
    /*-----------------------------
     ...
     $(window).on('elementor/frontend/init', function() {
         ...
         elementorFrontend.hooks.addAction('frontend/element_ready/qs_content_sldier_widget.default', Slick_Carousel_Script_Handle);
         elementorFrontend.hooks.addAction('frontend/element_ready/Reserving_WooCommerce_Products_Widget.default', Slick_Carousel_Script_Handle);
         elementorFrontend.hooks.addAction('frontend/element_ready/Reserving_WooCommerce_Products_Widget.default', QS_Gen_Tab);
